...
* qualification.extension[registration-status].valueCodeableConcept.coding.system = "https://standards.digital.health.nz/CodeSystem/practitioner-qualificationstatus"
